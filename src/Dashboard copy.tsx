...
import {
  Container,Image,Badge,HStack,Icon, Box,Tooltip, Heading, Text, Button, Stack, Flex, Table, Thead, Tbody, Tr, Th, Td, useDisclosure, Collapse, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton,
...
import studentImage2 from './photos/Avatar/student-avatar3.png'
...
const Dashboard: React.FC = () => {
  ...
  const studentImg = userType == 1 ? studentImage : studentImage2;
    ...
    <Box mt={8} />
        ...
        {userType === 1 ? (
              ...
              <Collapse in={isCoursesOpen}>
                  ...
                  <Table variant="simple" size="md" width="100%">
                    <Thead>
                      <Tr>
                        ...
                        <Th position="sticky" color="black" top={0} bg="gray.100" width="40%" zIndex={1}>Course Name</Th>
                ...
                {userType === 1 && (
                  <Flex justifyContent="flex-end" mt={4}>
                    <Button colorScheme="teal" onClick={openAddCourseModal}>
                      Add New Course
                    </Button>
                  </Flex>
                )}
          ...
          <Stack spacing={6}>
            ...
            <Box>
              <Heading size="md" mb={4} textStyle="3xl">
                Active Courses
              </Heading>
              <Flex overflowX="auto" direction="row" gap={4}>
                ...
                <Table variant="simple" size="md" width="100%">
                  <Thead>
                    <Tr>
                      ...
                      <Th position="sticky" top={0} bg="gray.100" zIndex={1}></Th>
                    </Tr>
                  </Thead>
                  <Tbody>
                    {availableCourses.length > 0 ? (
